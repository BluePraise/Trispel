...
function webfont_google_fonts() {
  if ( !is_admin() ) {
    wp_register_style( 'webfont_oswald', 'http://fonts.googleapis.com/css?family=Oswald:400,700,300', '', null, 'screen' );
    wp_register_style( 'webfont_sourcesanspro', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700,900', '', null, 'screen' );
  }
}
